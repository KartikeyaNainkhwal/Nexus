    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center bg-bg-base overflow-hidden selection:bg-accent/30 selection:text-white pb-[10vh]">
            ...
            >
                ...
                <Suspense fallback={
                    <div className="glass-card rounded-[2rem] p-10 flex flex-col items-center justify-center min-h-[400px]">
                        <Loader2 className="w-8 h-8 text-accent animate-spin mb-4" />
                        <p className="text-text-muted font-medium">Loading workspace setup...</p>
                    </div>
                }>
                    <OnboardingForm />
                </Suspense>
