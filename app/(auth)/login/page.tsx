    ...
    >
      ...
      <motion.div variants={itemMotion}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="secondary" type="button" onClick={() => signIn('google', { callbackUrl })} className="h-11 bg-surface border-border-default hover:bg-bg-hover shadow-sm text-text-secondary font-semibold">
          ...
          <Button variant="secondary" type="button" onClick={() => signIn('github', { callbackUrl })} className="h-11 bg-surface border-border-default hover:bg-bg-hover shadow-sm text-text-secondary font-semibold">
